...
{
    public class HiddenInputWizardStep3Controller : Controller
    {
        ...
        public IActionResult Next(Step3ViewModel viewModel)
        {
            ...
            {
                return View("~/Views/HiddenInputWizard/Partials/_Step3.cshtml", viewModel);
            }

            var model = new WizardViewModel();

            return View("~/Views/HiddenInputWizard/Partials/_Step4.cshtml", model);
        }
